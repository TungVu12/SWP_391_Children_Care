...
namespace ASP_NET_MVC_Ver1.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(150, ErrorMessage = "Tên không quá 150 kí tự")]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                        $"Vui lòng xác nhận tài khoản của bạn bằng link <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");
